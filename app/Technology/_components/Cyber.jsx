      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center md:gap-32 relative z-10 md:ml-16">
          ...
          >
            ...
            <button 
              className="bg-[#0F9D58] text-black px-6 md:px-8 py-2 md:py-3 rounded-full text-base md:text-lg font-medium flex items-center gap-2 md:gap-3 hover:bg-green-500 transition-colors mx-auto md:mx-0"
              data-aos="zoom-in"
              data-aos-delay="700"
            >
              Learn More
