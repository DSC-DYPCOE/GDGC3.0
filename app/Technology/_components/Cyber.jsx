        ...
        <div className="flex items-center gap-32 relative z-10 ml-16">
          ...
          <div className="flex-shrink-0">
            <div className="w-48 h-48  rounded-full flex items-center justify-center shadow-lg">
              <Image
                src="/CyberPassword.png"  // Replace with your image path
                alt="CyberSecurity"
                width={180}
                height={140}
          ...
          <div className="flex-grow max-w-2xl">
            ...
            <button className="bg-[#0F9D58] text-black px-8 py-3 rounded-full text-lg font-medium flex items-center gap-3 hover:bg-green-500 transition-colors">
              Learn More
